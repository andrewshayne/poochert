...
var worker_default = {
  async fetch(request, env) {
    ...
    if (pathname.includes(".") || pathname.startsWith("/assets/") || pathname === "/favicon.ico") {
    ...
    if (subRoute === "api" && pathParts[2] === "upload" && method === "POST") {
      ...
      const takenAt = formData.get("takenAt") || (/* @__PURE__ */ new Date()).toISOString().split("T")[0];
...
// .wrangler/tmp/bundle-MQRTES/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-MQRTES/middleware-loader.entry.ts
